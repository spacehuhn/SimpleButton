...
// these are the analog values of each button, they probably are different on your matrix, so test and change the values!
...
void setup() {
  ...
  for(int i=0;i<MATRIX_SIZE;i++){
    matrix[i] = new ButtonAnalog(A0, addresses[i]-10, addresses[i]+10);
  }
